...
?>
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<img src="admin/productimages/<?php echo htmlentities($rws['id']);?>/<?php echo htmlentities($rws['productImage1']);?>"  width="200" height="240" alt="">
							</div>
...
<?php if($row['productAvailability']=='In Stock'){?>
					...
					<?php } ?>
							...
							<h3>No. de tallas disponibles:</h3>

<div class="contenedor-botones">
  <button class="boton-seleccionable" onclick="toggleSeleccion(this)" id="opcion1">25 mxn</button>
  <button class="boton-seleccionable" onclick="toggleSeleccion(this)" id="opcion2">26 mxn</button>
  <button class="boton-seleccionable" onclick="toggleSeleccion(this)" id="opcion3">27 mxn</button>
  <button class="boton-seleccionable" onclick="toggleSeleccion(this)" id="opcion2">28 mxn</button>
  <button class="boton-seleccionable" onclick="toggleSeleccion(this)" id="opcion3">29 mxn</button>
</div>

<script>
function toggleSeleccion(boton) {
  var botones = document.getElementsByClassName("boton-seleccionable");
  
  for (var i = 0; i < botones.length; i++) {
    botones[i].classList.remove("boton-seleccionado");
  }
  
  boton.classList.toggle("boton-seleccionado");
}
</script>
					...
					<div class="row">
						<div class="col-sm-3">
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
								...
								<li><a data-toggle="tab" href="#review">Calificar</a></li>
...
<textarea class="form-control txt txt-review" id="exampleInputReview" rows="4" placeholder="" name="review" required="required"></textarea>
							...
							<div id="preguntas" class="">
										<form role="form" class="cnt-form" name="preguntas" method="post">
										<div class="product-add-preguntas">
											<h4 class="title">¿Tienes alguna pregunta?</h4>
											<div class="preguntas-form">
												<div class="form-container">
															<div class="row">
															<div class="col-sm-6">
																<div class="form-group">
																	<label for="exampleInputName">correo <span class="astk">*</span></label>
																<input type="text" class="form-control txt" id="exampleInputName" placeholder="Ingresa tu correo" name="name" required="required">
																</div><!-- /.form-group -->
																<div class="form-group">
																	<label for="exampleInputSummary">Escribe tu pregunta <span class="astk">*</span></label>
																	<textarea class="form-control txt txt-review" id="exampleInputpreguntas" rows="4" placeholder="Escribe tu pregunta" name="preguntas" required="required"></textarea>
																	<br>
																	<div class="action text-right">
															<button name="" class="btn btn-primary btn-upper">ENVIAR PREGUNTA</button>
														</div><!-- /.action -->
																</div><!-- /.form-group -->
															</div>
