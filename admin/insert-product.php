...
<option value="">Seleccine una Categoria</option> 
...
<div class="control-group">
<label class="control-label" for="basicinput">Precio del producto despues de la venta(Precio de venta)</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">PDisponibilidad de producto</label>
<div class="controls">
