...
<div class="form-group">
	    	<label class="info-title" for="contactno">No. telefonico <span>*</span></label>
...
<div class="form-group">
	...
	<div class="checkbox">
		...
		Realizar un seguimiento de sus pedidos fácilmente.
		</label>
		<label class="checkbox">
		Mantener un registro de todas sus compras.
		</label>
	</div>
</div>	
