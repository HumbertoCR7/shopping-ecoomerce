...
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "MXN"." ".$row['shippingCharge']; ?>.00</span></td>
					...
					<td class="cart-product-grand-total"><span class="cart-grand-total-price"><?php echo ($_SESSION['cart'][$row['id']]['quantity']*$row['productPrice']+$row['shippingCharge']); ?>.00 MXN</span></td>
				</tr>
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						Total:<span class="inner-left-md"><?php echo $_SESSION['tp']="$","$totalprice". ".00 MXN"; ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
